...
% DADOS DO TRABALHO--------------------------------------------------------------------------------------
\titulo{Análise de Dados e Aprendizado de Máquina aplicados ao monitoramento de problemas públicos em Belo Horizonte}
...
\instituicao{Instituto Federal de Educação, Ciência e Tecnologia de Minas Gerais - IFMG --- Campus Sabará}
\departamento{} % Se não existir departamento deixar em branco
\programa{Bacharelado em Sistemas de Informação - BSI}
