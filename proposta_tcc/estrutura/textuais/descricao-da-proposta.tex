...
Além disso, o simples incremento de dados à essa análise pode ocultar ou impedir a captura de mudanças, que embora possam parecer sutis, são importântes para a sua eficácia, tais como alterações na localização das concentrações do fenômeno e sazonalidades. Conforme conceitou Robinson \cite{Robinson1950}, ``falácia ecológica'' (\textit{``Ecological Fallacy''}) refere-se a um tipo de erro lógico que se pode cometer ao inferir comportamentos individuais a partir de estatísticas de dados agregados. Por sua vez, Weisburd \cite{Weisburd2015} sintetizou a importância da análise espacial por meio de \textit{hotspots}, ou pontos quentes, onde há concentração de crimes. Acrescenta-se, ainda, o efeito de deslocamento geográfico (\textit{displacement}) conceituado por Barr \cite{Barr1990}, que explorou as diferentes formas como o crime se move em resposta a ações de prevenção. A Figura representa esse deslocamento espacial.

\begin{table}[h!]
\centering
  \begin{tabular}{|m{3cm}|m{3cm}|m{3cm}|m{3cm}|} % Define colunas com largura fixa
    \hline
    \includegraphics[width=3cm]{dados/images/mapa_20231_2.png} & \includegraphics[width=3cm]{dados/images/mapa_20232_2.png} & \includegraphics[width=3cm]{dados/images/mapa_20233_2.png} & \includegraphics[width=3cm]{dados/images/mapa_20234_2.png} \\ \hline
    \includegraphics[width=3cm]{dados/images/mapa_20241_2.png} & \includegraphics[width=3cm]{dados/images/mapa_20242_2.png} & \includegraphics[width=3cm]{dados/images/mapa_20243_2.png} & \includegraphics[width=3cm]{dados/images/mapa_20244_2.png} \\ \hline
  \end{tabular}
  \caption{Tabela com 8 imagens}
  \label{tab:tabela_imagens}
\end{table}
