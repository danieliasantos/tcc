...
Podemos citar alguns desafios que podem impactar o estudo. Alguns deles poderão ser contornados durante a execução do trabalho, mas outros, somente após a implementação, por meio de acompanhamento por um período de testes. Outros, dependerão de acompanhamento das percepções operacionais do fenômeno, junto a agentes. Estes últimos poderão ser melhor tratados em evoluções futuras deste trabalho. Tem-se:
